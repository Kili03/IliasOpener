...
frame = Frame(root, width=400, height=150, background="#202124", padx=25, pady=25)
...
l2 = Label(frame, text="Nice, aren't they", font = ("Roboto", 10, "normal"), background="#202124", foreground="white")
